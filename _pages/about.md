...
- W. Li, et al. (2025).  
  *Inference-Time Value Alignment in Offline Reinforcement Learning: Leveraging LLMs for Reward and Ethical Guidance.*  
  Workshop on WORDPLAY: WHEN LANGUAGE MEETS GAME at \textbf{EMNLP}.
- W. Li, W. Mustafa, et al. (2025).  
  *Inference-Time Preference-Aligned Diffusion Planning for Safe Offline Reinforcement Learning.*  
  Proceedings of the Third Workshop on Hybrid Human-Machine Learning and Decision Making (HHMLDM) at \textbf{ECML PKDD} *(Oral Presentation)*.
- W. Li, R. Devidze, W. Mustafa, and S. Fellenz.(2024) Ethics in Action: Training Reinforcement Learning Agent for Moral Decision-making In Text-based Adventure Games. Proceedings of International Conference on Artificial Intelligence and Statistics (AISTATS) [Abstract](files/abstract2.pdf)
